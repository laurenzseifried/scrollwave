...
- Als Zwischenlösung ist ein experimenteller, rein lokaler Focus Mode implementiert und ausgeloggt im Android-36-Emulator geprüft: Reddit selbst rendert und lädt die Seite; die App blendet bei normalen Medienbeiträgen die Reddit-Karte aus und zeigt nur das proportionale Fullscreen-Medium, minimale Metadaten, Snapping und die Ein-Video-Steuerung. Reddit-Navigation ist über `Feeds` zuschaltbar und Werbung bleibt gemäß Plattformregel sichtbar. Es gibt keinen Proxy und keine separate Datensammlung. Login und echte Custom-Feed-/Redgifs-Tests stehen noch aus.
